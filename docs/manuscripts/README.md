...
|---|---|---|
| `paper1/` | Pre-registered gradient-variance measurement on ibm_phoenix with the reset-dial arm (pre-registration v0.9.9, H1-H7, Gates 1, 1b, 2) | revtex4-2, `prxquantum` (PRX Quantum / QST) |
| `paper2/` | 120-qubit reset / mid-circuit-measurement characterisation (pre-registration v0.4.2, Q1-Q5) | revtex4-2, `pra` (PRA / QST) |
...
| `deviations.yaml` | Deviations 14-31 (Paper 1) and 1-3 (Paper 2), transcribed from the pre-registrations | data |
...
The papers need `revtex4-2` (TeX Live `revtex` bundle), `booktabs`, `longtable`, `xcolor`, `hyperref`.
