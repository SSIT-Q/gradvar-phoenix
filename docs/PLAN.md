...
- Paper 1 pre-registration v0.9.7: https://claude.ai/artifact/C2RMiQMPq5qonMAYNaEqex
...
| Gate 2 smoke test | The Paper 1 campaign | The ibm_phoenix smoke test returns locked time per point, reset error and latency, the depth ceiling and the rep_delay ladder (P1.2.8); the re-based minute budget under the Deviation 24 model (P1.1.15) fits the 360-minute allocation with reserve intact. Two decisions for the PI before Gate 2 (P1.2.9, P1.2.10): L = 12 predictions below the 4096-shot floor; L = 8 rows below the criterion (d) allowance at 16384 shots; the shot-budget decision (P1.2.11, Deviation 32 candidate) precedes the smoke test. | R, O | 30 Sep 2026 |
