...
Two papers, one allocation. Version 17, 20 September 2026 (first version 19 September 2026); last updated 20 Sep 2026, 09:40 IST. Version 17 changes: Paper 1 pre-registration v0.11.3 (Deviation 41 dial kill line 7.0 min incl. overhead; 42 ten pre-data analysis clarifications; 43 null_control point type, H1 part 2 / H2 at L = 8/12 exploratory, +2.6 min reserve; 44 three depth-8 Gate 1b references at 16384 shots, +8.0 min reserve, 4.9 min unallocated) and Paper 2 pre-registration v0.4.4 (Deviation 6 qubit 79 isolated, separate 0.9-min job, campaign 36.3 min; Deviation 7 Q4 depth-first edge rule, 480 ns cycle idle, spectator-echo spec, data policy); P1.4.9 manuscripts merged (64d3d0c); P1.4.10 and P2.2.1 reviewed, p2-runner merged (4841d49); P1.1.16 and P1.1.17 done on pp-zz-idle (9cdc673, 0 deferred); P1.1.20 in progress; P1.2.2 waiting on Owais's arming step; rows P1.1.23, P1.2.13 and P1.2.14 added; reserve re-itemised. Weekly review every Monday in #mitacs. Paper 2 direction decided 19 Sep 2026, 23:39 IST: the hybrid.
...
4. Minutes: ledger of pre-registration v0.9.7, Section 6, re-based at the 1 µs default rep_delay: Paper 1 main grid 200, reset-dial arm 65 (Deviation 27), Paper 2 characterisation 45, reserve 50 = 360, no separate dry-run bucket; predicted use about 156 minutes. Any surplus goes first to raising M (Deviation 17), never to new tests.
...
- Paper 1 pre-registration v0.11.3: https://claude.ai/artifact/C2RMiQMPq5qonMAYNaEqex
- Gate 1 report: https://claude.ai/artifact/1PRkEbpq7Hp987WTdtnM9Q
- Paper 2 pre-registration v0.4.4: https://claude.ai/artifact/RCTX4qqws9xiZRxMZd22Xh
